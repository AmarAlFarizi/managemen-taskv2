...
const TaskCard = ({ task, onDone, onDelete }) => (
  <div className="flex justify-between items-center p-3 bg-gray-700 rounded-lg">
    ...
    <div className="flex space-x-2">
      <button onClick={() => onDone(task._id)} className="text-green-400 hover:text-green-600">
      <img src={logo} alt="done" className="w-8 h-8 " /> 
      </button>
      <button onClick={() => onDelete(task._id)} className="text-green-400 hover:text-green-600">
